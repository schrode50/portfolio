...
let plugins = [
  ...
  new webpack.optimize.CommonsChunkPlugin({
    name:       'main', //moving dependencies to main file
    children:   true, //checking for common dependencies
    minChunks:  2 //establishing minimum redundancy of dependencies requiring extraction
  }),
];
